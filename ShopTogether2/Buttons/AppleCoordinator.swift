...
class AppleCoordinator: NSObject, ASAuthorizationControllerPresentationContextProviding {
...
@available(iOS 13.0, *)
extension AppleCoordinator: ASAuthorizationControllerDelegate {
      ...
      let credential = OAuthProvider.credential(withProviderID: "apple.com",
        ...
        Auth.auth().currentUser?.link(with: credential, completion: { (authresult, error) in
            ...
            if let error = error, (error as NSError).code == AuthErrorCode.credentialAlreadyInUse.rawValue {
                ...
                print("The Apple account you're signing in to is already in use. ")
